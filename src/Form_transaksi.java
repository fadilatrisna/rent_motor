...
public class Form_transaksi extends javax.swing.JFrame {
    ...
    String NO_TRANSAKSI, KODE_PENYEWA, NO_KENDARAAN, MEREK_MOTOR, HARGA, LAMA, TOTAL, BAYAR, KEMBALI;
    ...
    public void getDataPenyewa(){
            ...
            model.fireTableDataChanged();
               ...
               try{
                ...
                while(res.next()){
                   ...
                   obj[1]=res.getString("kode_penyewa");
            ...
            public void loadData_penyewa(){
                ...
                public void dataselect(){
                    ...
                    String  sql = "INSERT INTO transaksi(no_transaksi, kode_penyewa, no_kendaraan, merek_motor, harga_sewa, lama_sewa, total_bayar, bayar, kembali)" + "VALUES('"+ NO_TRANSAKSI +"','"+ KODE_PENYEWA +"','"+ NO_KENDARAAN +"','"+ MEREK_MOTOR +"','"+ HARGA +"','"+ LAMA +"','"+ TOTAL +"','"+ BAYAR +"','"+ KEMBALI +"')";
                ...
                public void rubahDataPenyewa(){
                  ...
                  try{
                     ...
                     String sql = "UPDATE transaksi SET nama = '"+ KODE_PENYEWA +"',"
    ...
    private void initComponents() {
        ...
        hitungtotal.setFont(new java.awt.Font("Rockwell", 1, 12)); // NOI18N
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGap(22, 22, 22)
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(tnama, javax.swing.GroupLayout.DEFAULT_SIZE, 120, Short.MAX_VALUE)
                            .addComponent(tno))
                        .addGap(66, 66, 66)
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
